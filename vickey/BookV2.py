...
class Book(unittest.TestCase):
    ...
    def test_p_delta(self):
        ...
        print()
        print("P delta:")
        print("here k is > max_delta_size")
        print("this is a good news in the context of studying the differences")
        print("it means that there is not enough difference level to compute genuine difference")
        print("it means that, according to our criteria no genuine differences exists")
        print("Genuine Dif: 0")
        print("Weak Dif: " + str(len(p)))

        self.G_DIF.append(0)
        self.W_DIF.append(len(p))
    ...
    def test_p_epsilon_omega(self):
        ...
        k = 3
        self.assertTrue(k < max_epsilon_size)
        filter_id = compute_filter_identity(max_epsilon_size,k)
        genuine_ide = []
        weak_ide = []
    ...
    def test_p_omega(self):
        ...
        # here is there is weak inc, we will not be able to re-affect the pairs
