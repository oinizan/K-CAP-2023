...
class Mountain(unittest.TestCase):
    # P Epsilon G Ide
    G_IDE = []
    ...
    def make_partitions(self):
        all_contexts = compute_epsilon_delta_omega_mountain()
    ...
    def test_p_epsilon_omega(self):
        ...
        k = 3
        # max_epsilon_size is > k all identities
    ...
    def test_p_epsilon_delta_omega(self):
        ...
        # compute filter incompletness, returns 1
        filter_inc = compute_filter_incompletness(max_omega_size)
